...
function testDampenedReport(report: Array<number>, failedLevel: number): boolean {
	const allDampenedVariants: Array<Array<number>> = Array.from(
		{ length: report.length },
		(_, i) => [...report.slice(0, i), ...report.slice(i + 1)]
	);
